...
public class RtpStream {
    ...
    RtpStream(int pt, int sampleRate, RtpSocket socket) {
        this.payloadType = pt;
    ...
    private void addPacket(byte[] prefixData, byte[] data, int offset, int size, long timeUs) throws IOException {
    ...
    private void sendPacket(ByteBuffer buffer, int size) throws IOException {
